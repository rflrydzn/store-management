export default function InventorySummary() {
  return (
    <section className="flex gap-4 p-4 overflow-x-auto no-scrollbar">
      <div className="flex min-w-40 flex-1 flex-col gap-2 rounded-xl p-5 bg-white dark:bg-slate-800 border border-slate-100 dark:border-slate-700 shadow-sm">
      ...
      <div className="flex min-w-40 flex-1 flex-col gap-2 rounded-xl p-5 bg-red-50 dark:bg-red-950/20 border border-red-100 dark:border-red-900/30 shadow-sm">
